...
class Stack : SourcedPlotElement {
	private SourcedPlotElement parent;

	public Stack(SourcedPlotElement parent, String srcName, Color color):base(srcName, color) {
		this.parent = parent;
	}

	public override void assignValues(DataProcessor dproc){
