...
{
	public class TimeAxisSetting {
	internal long secPerPix;
	internal int minorUnit, minorUnitCount, majorUnit, majorUnitCount;
	internal int labelUnit, labelUnitCount, labelSpan;
	internal String format;

	internal TimeAxisSetting(long secPerPix, int minorUnit, int minorUnitCount, int majorUnit, int majorUnitCount,
	...
	internal TimeAxisSetting(TimeAxisSetting s)
	{
	...
	internal TimeAxisSetting(int minorUnit, int minorUnitCount, int majorUnit, int majorUnitCount,
					int labelUnit, int labelUnitCount, int labelSpan, String format): 
