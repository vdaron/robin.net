...
public class RrdGraphDef {
	public bool poolUsed = false; // ok
	public bool antiAliasing = false; // ok
	public String filename = RrdGraphConstants.IN_MEMORY_IMAGE; // ok
	public long startTime; // ok
	public long endTime; // ok
	public TimeAxisSetting timeAxisSetting = null; // ok
	public ValueAxisSetting valueAxisSetting = null; // ok
	public bool altYGrid = false; // ok
	public bool noMinorGrid = false; // ok
	public bool altYMrtg = false; // ok
	public bool altAutoscale = false; // ok
	public bool altAutoscaleMax = false; // ok
	public int unitsExponent = int.MaxValue; // ok
	public int unitsLength = RrdGraphConstants.DEFAULT_UNITS_LENGTH; // ok
	public String verticalLabel = null; // ok
	public int width = RrdGraphConstants.DEFAULT_WIDTH; // ok
	public int height = RrdGraphConstants.DEFAULT_HEIGHT; // ok
	public bool interlaced = false; // ok
	public String imageInfo = null; // ok
	public String imageFormat = RrdGraphConstants.DEFAULT_IMAGE_FORMAT; // ok
	public float imageQuality = RrdGraphConstants.DEFAULT_IMAGE_QUALITY; // ok
	public String backgroundImage = null; // ok
	public String overlayImage = null; // ok
	public String unit = null; // ok
	public String signature = "Created with JRobin"; // ok
	public bool lazy = false; // ok
	public double minValue = Double.NaN; // ok
	public double maxValue = Double.NaN; // ok
	public bool rigid = false; // ok
	public double base_renamed = RrdGraphConstants.DEFAULT_BASE;  // ok
	public bool logarithmic = false; // ok

	internal Color[] colors = new Color[] {
			// ok
			RrdGraphConstants.DEFAULT_CANVAS_COLOR,
			RrdGraphConstants.DEFAULT_BACK_COLOR,
			RrdGraphConstants.DEFAULT_SHADEA_COLOR,
			RrdGraphConstants.DEFAULT_SHADEB_COLOR,
			RrdGraphConstants.DEFAULT_GRID_COLOR,
			RrdGraphConstants.DEFAULT_MGRID_COLOR,
			RrdGraphConstants.DEFAULT_FONT_COLOR,
			RrdGraphConstants.DEFAULT_FRAME_COLOR,
			RrdGraphConstants.DEFAULT_ARROW_COLOR
	};

	public bool noLegend = false; // ok
	public bool onlyGraph = false; // ok
	public bool forceRulesLegend = false; // ok
	public String title = null; // ok
	public long step = 0; // ok
	public Font smallFont;
	public Font largeFont;
	public bool drawXGrid = true; // ok
	public bool drawYGrid = true; // ok
	public DayOfWeek firstDayOfWeek = RrdGraphConstants.FIRST_DAY_OF_WEEK; // ok
	public bool showSignature = true;
	//File fontDir = null;

	internal List<Source> sources = new List<Source>();
	internal List<CommentText> comments = new List<CommentText>();
	...
	public RrdGraphDef() {
		...
		smallFont = new Font(RrdGraphConstants.DEFAULT_FONT_NAME,10);
		largeFont = new Font(RrdGraphConstants.DEFAULT_FONT_NAME,12,FontStyle.Bold);
	}
	 ...
	 * and grid. The base_renamed grid, the major grid and the labels.
	 ...
	 * of the label.
	 * <p/>
	 * For example, if you wanted a graph with a base_renamed grid every 10 minutes and a major
	...
	/**
	 * Sets default base_renamed for magnitude scaling. If you are graphing memory
	 ...
	 *
	 * @param base_renamed Base value (defaults to 1000.0)
	 */
	public void setBase(double base_renamed) {
	...
	private static int getColorTagByName(String colorName){
		for (int i = 0; i < RrdGraphConstants.COLOR_NAMES.Length; i++) {
			if (RrdGraphConstants.COLOR_NAMES[i].Equals(colorName,StringComparison.InvariantCultureIgnoreCase)) {
				return i;
			}
		}
	 ...
	 */
	public void datasource(String name, String rrdPath, String dsName, ConsolidationFunction consolFun) {
	 ...
	 */
	public void print(String srcName, ConsolidationFunction consolFun, String format) {
     ...
     *            Color of the filled area.
     */
    public void area(String srcName, Color color) {
	...
	internal int printStatementCount() {
		int count = 0;
